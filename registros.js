document.getElementById("btn__Iniciar-Sesion").addEventListener("click",InisiarSesión);
document.getElementById("btn__Registrarse").addEventListener("click",register);
window.addEventListener("resize",anchopagina);

//*Deccalrqacion de varaiables*//
...
function anchopagina(){
    if(window.innerWidth > 850){
        ...
        caja_trasera_login.style.display = "block";
        formulario_login_register.style.display = "none";
        contenedor_login_register.style.display = "0px";
    }
}
anchopagina();

function InisiarSesión(){ 
    if(window.innerWidth> 850){
...
function register(){ 
    ...
    contenedor_login_register.style.display = "410px";
